...
EDF stands for **E**stimated **D**egrees of **F**reedom. Without going into details, it roughly represents the the level of "wiggliness" of the smooth term. 
...
g<-gam(y~s(x1)+s(x2)+s(x3,bs="tp"),data=dat)
...
[Generalized Additive Models, An Introduction with R](https://www.crcpress.com/Generalized-Additive-Models-An-Introduction-with-R-Second-Edition/Wood/p/book/9781498728331) by Simon Wood, author of the mgcv package
